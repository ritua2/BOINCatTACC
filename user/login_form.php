...
//Make sure that users who already log in as a researcher, can't log in as a volunteer as well
if(!isset($_SESSION['user'])){//Added by Gerald Joshua
