...
echo '
		...
		<div id="automatedDockerSection">
			...
			<div class="dropdown" style="margin: -1.5% 0 0 35%;" >
				...
				<input type="hidden" id="osListParam" name="operating_system">
		  		<ul id="osDropDown" class="dropdown-menu">
		    			<li value="ubuntu_16_04"><a href="javascript:;">Ubuntu-16.04</a></li> 		
				</ul>
			</div>
			...
			<div style="margin: -1.5% 0 0 34.5%;">
				<br/>
				<textarea id="" name="commandLine" value="none" style="margin: -3% 0 0 0; width: 64.5%;padding: 10px; border-radius: 5px;" rows="7" placeholder="e.g., gcc -o hello.exe hello.c (hit enter at each of the end the command line including the last command line)"></textarea>
				<br/>
			</div>
			...
			<div style="margin: -1.5% 0 0 34.5%;">
				<input type="text" class="form-control" placeholder="e.g., output_file.txt, result.txt (List all the ouput files with its file extension. Separate each output file with a comma)" name="outputFileList" />
			</div>
			...
			<!-- Input Files -->
			<div style="margin: -1.5% 0 0 34.5%;">
				<label style="margin-left:"><input type="radio" id="tarUpload" checked="checked">
				<span style="margin-left:5px;">Tar Upload</span></label>

				<label style="margin-left: 3%;"><input type="radio" id="zipUpload"><span style="margin-left: 5px;">Zip Upload</span></label>

				<label style="margin-left:3%;"><input type="radio" id="noUpload">
				<span style="margin-left:5px;">No Input Files</span></label><br />
				<label class="btn btn-success btn-file" style="font-weight:bold;">
	    			Browse <input type="file" name="midas_input_file" style="display: none;">
				</label>
				<span class="label label-info" id="" style="font-size: 14px;">No file chosen</span>
				<br />
				<span id="warningMsg" style="color: red; font-weight: bold;">
				<br />
				</span>
				<br />
				<input type="hidden" id="" value="" />
				<input class="btn btn-success" type="submit" id="" style="font-weight: bold;">
				<br/>
