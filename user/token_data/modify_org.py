...
if len(sys.argv) == 1:
        ...
        print('Note: This system allows to remove an user from an organization, but does not remove its privilees for submitting jobs')
        ...
        print('  -org_info ORG_NAME: Returns all the information about the organization')
        ...
        print('  -remove_user ORG_NAME USER_TOKEN')
        sys.exit()
