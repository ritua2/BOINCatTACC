...
if (get_str('action')=="hide") {
    ...
    row1(tra("Are you sure you want to banish %1 ?<br/>This will prevent %1 from posting for chosen time period.<br/>It should be done only if %1 has consistently exhibited trollish behavior.", forum_moderate_post($user->name)));
